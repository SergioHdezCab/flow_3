...
Se utilizà el dashboard para representar informacion de la fecha y hora con el timestamp
## Material Necesario
...
![](https://github.com/NYamDN/flow_3/blob/main/imagenes/image.png?raw=true)

![](https://github.com/NYamDN/flow_3/blob/main/imagenes/image(1).png?raw=true)
